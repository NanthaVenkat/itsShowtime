...
switch ($action) {
			...
			<div class="admin-email__actions">
				<div class="admin-email__actions-primary">
					...
					<input type="submit" name="correct-admin-email" id="correct-admin-email"
						class="button button-primary button-large red" value="<?php esc_attr_e('The email is correct'); ?>" />
				</div>
	...
	case 'retrievepassword':
		...
		<form name="lostpasswordform" id="lostpasswordform"
			...
			<input type="hidden" name="redirect_to" value="<?php echo esc_attr($redirect_to); ?>" />
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large red"
			...
			<div class="user-pass-wrap">
				...
				<div class="wp-pwd">
					...
					<button type="button" class="button button-secondary wp-hide-pw hide-if-no-js" data-toggle="0"
						...
						<span class="dashicons dashicons-visibility red" aria-hidden="true"></span>
					</button>
				</div>
			</div>
			<?php
