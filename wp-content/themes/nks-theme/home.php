...
<main class="blog-listing-page bg-white pb-20">
    ...
    <?php if ($hero_post):
        ...
        <div class="blog-hero relative overflow-hidden bg-center bg-cover h-screen p-4 md:p-10 flex">
            ...
            <div class="container mx-auto relative z-10 text-white max-w-5xl ml-0">
                <span
                    class="inline-flex items-center tag-label bg-primary text-white text-xs font-bold px-3 py-1 rounded inline-block mb-4"><img
                        src="http://localhost/showtime/wp-content/uploads/2026/03/trending.svg" alt="" width="10" height="10" class="inline-block mr-1"> Trending</span>
                <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                    <?php echo esc_html($hero_post->post_title); ?>
                </h1>
                <p class="text-lg md:text-xl text-white max-w-2xl mb-8 leading-relaxed">
    ...
    <section class="py-20 px-4 md:px-10 lg:px-20">
        <div class="container mx-auto">
            ...
            <?php if ($featured_post):
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16">
                    <div class="relative overflow-hidden aspect-[16/9] shadow-lg">
                        <span
                            class="inline-flex items-center mb-4 tag-label bg-primary text-white text-xs font-bold px-3 py-1 rounded"><img
                                src="http://localhost/showtime/wp-content/uploads/2026/03/trending.svg" alt="" width="10" height="10" class="inline-block mr-1">
                            Trending</span>
                        <img src="<?php echo esc_url($featured_thumb); ?>"
                            alt="<?php echo esc_attr($featured_post->post_title); ?>" class="w-full h-full object-cover">
                    </div>
                    <div>
                        <h2 class="text-lg md:text-xl font-bold text-primary mb-6 leading-tight">
                            <?php echo esc_html($featured_post->post_title); ?>
                        </h2>
                        <p class="text-phara text-md leading-relaxed mb-8">
                            <?php echo esc_html(get_the_excerpt($featured_post->ID)); ?>
                        </p>
                        <a href="<?php echo get_permalink($featured_post->ID); ?>"
                            class="inline-block bg-primary text-white px-4 py-2 rounded-lg font-medium hover:bg-red-700 transition-colors text-sm tracking-wider">
                            Read more
                        </a>
                    </div>
                </div>
            ...
            <h2 class="text-md font-semibold tracking-tight mb-7 text-[#252525]">Recent blog posts
            </h2>
