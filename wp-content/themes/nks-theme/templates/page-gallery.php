...
<main class="gallery-page bg-[#f3f3f3] text-[#151515] overflow-x-hidden">
    <!-- Page hero section -->
    <section class="pt-40 pb-16">
        <div class="container mx-auto px-4 lg:px-10 text-center">
            ...
            <?php if($hero_subtitle): ?>
                <p class="text-phara text-base max-w-2xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    ?>
                        <article>
                            ...
                            <div class="flex flex-wrap items-center justify-between text-[#252525] gap-3 text-base md:text-lg">
