            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide relative hero-slide">
                    ...
                    <div class="bg-cover bg-center h-full relative flex items-end justify-start hero-slide__bg"
                        ...
                        <!-- Overlay -->
                        <div
                            class="absolute inset-0 bg-linear-to-t from-black via-black/50 to-transparent hero-slide__overlay">
                        </div>

                        <!-- Content -->
                        <div
                            class="relative max-w-3xl z-10 container px-6 py-8 lg:px-16 lg:py-18 mb-6 hero-slide__content">
